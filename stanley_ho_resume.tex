...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item[]{
      \begin{deflist}
        \item[\textbf{Languages}]{C++, C, Python, JavaScript, Matlab, Shell Script, Java, SQL} \vspace{-5pt}
      \end{deflist}
    }
    \item[]{
      \begin{deflist}
